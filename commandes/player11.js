...
const {addOrUpdateDataInPlayer11 , getDataFromPlayer11} = require('../bdd/player11')
...
zokou(
 ...
 const data = await getDataFromPlayer11();
...
await addOrUpdateDataInPlayer11(texte , tlien)
