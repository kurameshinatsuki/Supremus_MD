...
const {addOrUpdateDataInRolistecrps , getDataFromRolistecrps} = require('../bdd/rolistecrps')
...
zokou(
 ...
 const data = await getDataFromRolistecrps();
...
await addOrUpdateDataInRolistecrps(texte , tlien)
