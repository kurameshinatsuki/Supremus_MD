...
const { addOrUpdateDataInPlayer18, getDataFromPlayer18 } = require('../bdd/player18');
...
zokou(
    {
        ...
        const data = await getDataFromPlayer18();
        ...
        if (!arg || !arg[0] || arg.join('') === '') {
            ...
            await addOrUpdateDataInPlayer18(texte, tlien);
