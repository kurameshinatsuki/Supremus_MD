...
const {addOrUpdateDataInPlayer15 , getDataFromPlayer15} = require('../bdd/player15')
...
zokou(
 ...
 const data = await getDataFromPlayer15();
...
await addOrUpdateDataInPlayer15(texte , tlien)
