...
const {addOrUpdateDataInPlayer13 , getDataFromPlayer13} = require('../bdd/player13')
...
zokou(
 ...
 const data = await getDataFromPlayer13();
...
await addOrUpdateDataInPlayer13(texte , tlien)
