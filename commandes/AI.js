...
zokou({nomCom:"bot",reaction:"🤖",categorie:"MON-BOT"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  zokou({ nomCom: "dalle", reaction: "🤖", categorie: "MON-BOT" }, async (dest, zk, commandeOptions) => {
  ...
  zokou({ nomCom: "gpt", reaction: "🤖", categorie: "MON-BOT" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
