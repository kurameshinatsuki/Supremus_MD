...
const { addOrUpdateDataInPlayer20, getDataFromPlayer20 } = require('../bdd/player20');
...
zokou(
    {
        ...
        const data = await getDataFromPlayer20();
        ...
        if (!arg || !arg[0] || arg.join('') === '') {
            ...
            await addOrUpdateDataInPlayer20(texte, tlien);
