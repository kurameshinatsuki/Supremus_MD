...
const { addOrUpdateDataInPlayer19, getDataFromPlayer19 } = require('../bdd/player19');
...
zokou(
    {
        ...
        const data = await getDataFromPlayer19();
        ...
        if (!arg || !arg[0] || arg.join('') === '') {
            ...
            await addOrUpdateDataInPlayer19(texte, tlien);
