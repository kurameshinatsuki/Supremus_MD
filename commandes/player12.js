...
const {addOrUpdateDataInPlayer12 , getDataFromPlayer12} = require('../bdd/player12')
...
zokou(
 ...
 const data = await getDataFromPlayer12();
...
await addOrUpdateDataInPlayer12(texte , tlien)
